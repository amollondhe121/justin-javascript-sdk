...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('UpdateTransferOperatorBody', function() {
      beforeEach(function() {
        instance = new VerbwireApiDocumentation.UpdateTransferOperatorBody();
      });

      it('should create an instance of UpdateTransferOperatorBody', function() {
        // TODO: update the code to test UpdateTransferOperatorBody
        expect(instance).to.be.a(VerbwireApiDocumentation.UpdateTransferOperatorBody);
      });
      ...
      it('should have the property newOperatorAddress (base name: "newOperatorAddress")', function() {
        // TODO: update the code to test the property newOperatorAddress
        expect(instance).to.have.property('newOperatorAddress');
        // expect(instance.newOperatorAddress).to.be(expectedValueLiteral);
      });
