...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DataCreatedBody', function() {
      beforeEach(function() {
        instance = new VerbwireApiDocumentation.DataCreatedBody();
      });

      it('should create an instance of DataCreatedBody', function() {
        // TODO: update the code to test DataCreatedBody
        expect(instance).to.be.a(VerbwireApiDocumentation.DataCreatedBody);
      });
