...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DataTransactionsBody', function() {
      beforeEach(function() {
        instance = new VerbwireApiDocumentation.DataTransactionsBody();
      });

      it('should create an instance of DataTransactionsBody', function() {
        // TODO: update the code to test DataTransactionsBody
        expect(instance).to.be.a(VerbwireApiDocumentation.DataTransactionsBody);
      });
