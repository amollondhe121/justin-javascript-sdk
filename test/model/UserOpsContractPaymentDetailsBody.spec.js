...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('UserOpsContractPaymentDetailsBody', function() {
      beforeEach(function() {
        instance = new VerbwireApiDocumentation.UserOpsContractPaymentDetailsBody();
      });

      it('should create an instance of UserOpsContractPaymentDetailsBody', function() {
        // TODO: update the code to test UserOpsContractPaymentDetailsBody
        expect(instance).to.be.a(VerbwireApiDocumentation.UserOpsContractPaymentDetailsBody);
      });
