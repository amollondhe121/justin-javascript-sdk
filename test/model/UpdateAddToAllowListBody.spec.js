...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('UpdateAddToAllowListBody', function() {
      beforeEach(function() {
        instance = new VerbwireApiDocumentation.UpdateAddToAllowListBody();
      });

      it('should create an instance of UpdateAddToAllowListBody', function() {
        // TODO: update the code to test UpdateAddToAllowListBody
        expect(instance).to.be.a(VerbwireApiDocumentation.UpdateAddToAllowListBody);
      });
      ...
      it('should have the property mintSlots (base name: "mintSlots")', function() {
        // TODO: update the code to test the property mintSlots
        expect(instance).to.have.property('mintSlots');
        // expect(instance.mintSlots).to.be(expectedValueLiteral);
      });
