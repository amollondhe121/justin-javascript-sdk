...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('StoreFileBody', function() {
      beforeEach(function() {
        instance = new VerbwireApiDocumentation.StoreFileBody();
      });

      it('should create an instance of StoreFileBody', function() {
        // TODO: update the code to test StoreFileBody
        expect(instance).to.be.a(VerbwireApiDocumentation.StoreFileBody);
      });
