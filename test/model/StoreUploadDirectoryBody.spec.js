...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('StoreUploadDirectoryBody', function() {
      beforeEach(function() {
        instance = new VerbwireApiDocumentation.StoreUploadDirectoryBody();
      });

      it('should create an instance of StoreUploadDirectoryBody', function() {
        // TODO: update the code to test StoreUploadDirectoryBody
        expect(instance).to.be.a(VerbwireApiDocumentation.StoreUploadDirectoryBody);
      });
