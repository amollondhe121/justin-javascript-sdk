...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('UserOpsUserCollectionContractDetailsBody', function() {
      beforeEach(function() {
        instance = new VerbwireApiDocumentation.UserOpsUserCollectionContractDetailsBody();
      });

      it('should create an instance of UserOpsUserCollectionContractDetailsBody', function() {
        // TODO: update the code to test UserOpsUserCollectionContractDetailsBody
        expect(instance).to.be.a(VerbwireApiDocumentation.UserOpsUserCollectionContractDetailsBody);
      });
