...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('UserOpsAllowListSharesForAddressBody', function() {
      beforeEach(function() {
        instance = new VerbwireApiDocumentation.UserOpsAllowListSharesForAddressBody();
      });

      it('should create an instance of UserOpsAllowListSharesForAddressBody', function() {
        // TODO: update the code to test UserOpsAllowListSharesForAddressBody
        expect(instance).to.be.a(VerbwireApiDocumentation.UserOpsAllowListSharesForAddressBody);
      });
      ...
      it('should have the property allowListAddress (base name: "allowListAddress")', function() {
        // TODO: update the code to test the property allowListAddress
        expect(instance).to.have.property('allowListAddress');
        // expect(instance.allowListAddress).to.be(expectedValueLiteral);
      });
