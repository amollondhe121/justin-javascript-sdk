...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DataTransactionsByContractBody', function() {
      beforeEach(function() {
        instance = new VerbwireApiDocumentation.DataTransactionsByContractBody();
      });

      it('should create an instance of DataTransactionsByContractBody', function() {
        // TODO: update the code to test DataTransactionsByContractBody
        expect(instance).to.be.a(VerbwireApiDocumentation.DataTransactionsByContractBody);
      });
